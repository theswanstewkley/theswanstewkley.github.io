!(function () {
    ...
    ((t) => {
        ...
        const f = "data-",
            ...
            w = `https://willlewis.co.uk/api/send`,  // Updated line
            N = `${e}x${a}`,
            ...
            j = () => ({ website: h, hostname: s, screen: N, language: r, title: O(_), url: O(B), referrer: O(D), tag: g || void 0 }),
            k = (t, e, a) => {
            ...
            L = async (t, e = "event") => {
                ...
                try {
                    const r = await fetch(w, { method: "POST", body: JSON.stringify({ type: e, payload: t }), headers: a }),
                        n = await r.text();
                    return (K = n);
                } catch {}
            },
